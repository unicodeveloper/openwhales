              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <Link
                      href={`/ticker/${tx.ticker}`}
                      className="font-mono font-bold text-xs sm:text-sm text-amber-600 dark:text-amber-400 hover:underline"
                    >
                      {tx.ticker}
                    </Link>
                    <span className="text-xs sm:text-sm text-muted-foreground truncate max-w-[140px] sm:max-w-none">
                      {tx.companyName}
                    </span>
                    <span
