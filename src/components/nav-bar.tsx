    ...
    >
      <div className="container mx-auto flex h-16 items-center justify-between gap-4 px-6">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <span className="hidden md:inline-flex px-3 py-1.5 rounded-full border border-white/[0.08] bg-white/[0.04] backdrop-blur-md font-mono text-[10px] text-white/50">
            13F / 13D / Form 4
          </span>
        </div>
      </div>
